"""
Routine to load Loughran-McDonald financial sentiment lexicon master dicitonary
...
To run this script:
python3 MOD_Load_MasterDictionary_v2022_edited.py
"""

def load_masterdictionary(file_path, print_flag=False, get_other=False):
    # Setup dictionaries
    _master_dictionary = {}
